...
class Cast(Instruccion):
    ...
    CASTING = [
        [TYPE_DECLARATION.INTEGER, TYPE_DECLARATION.FLOAT, TYPE_DECLARATION.NULL, TYPE_DECLARATION.NULL, TYPE_DECLARATION.NULL, TYPE_DECLARATION.CHAR, TYPE_DECLARATION.NULL],
